...
SECRET_KEY = 'django-insecure-=)_%g4n0*d%vaa=l$d^=pzbhaji=y()63%vudy&2rcjh5pp+a!'
...
INSTALLED_APPS = [
    ...
    'easy_thumbnails',
    'filer',
    'mptt',                 # зависимость для дерева
    'django_ckeditor_5',
    # 'compressor',           # auto .less -> .css
    # 'django_recaptcha',
    # 'adminsortable2',
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # для хранения файлов в разработке
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # для сбора в продакшн

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# compressor pipeline (TODO: add compress to minimize static sizes :3)
# STATICFILES_FINDERS = [
